...
describe('Osc', () => {
  describe('start', () => {
    ...
    test('calls getNoteFreq with 43 when note is 36, octave is 10, and semi is 7', () => {
      ...
      osc.setSemi(7)
      osc.start(36)
      expect(getNoteFreq.mock.calls[0]).toEqual([43])
    })
    ...
    test('calls getNoteFreq with 55 when note is 36, octave is 10, and semi is 7', () => {
      ...
      osc.setSemi(7)
      osc.start(36)
      expect(getNoteFreq.mock.calls[0]).toEqual([55])
    })
    ...
    test('calls getNoteFreq with 60 when note is 36, octave is 2, and semi is 0', () => {
      ...
      osc.setOctave(2)
      osc.start(36)
      expect(getNoteFreq.mock.calls[0]).toEqual([60])
    })
    ...
    test('calls getNoteFreq with 0 when note is 36, octave is -3, and semi is 0', () => {
      ...
      osc.setOctave(-3)
      osc.start(36)
      expect(getNoteFreq.mock.calls[0]).toEqual([0])
    })
  })
})
